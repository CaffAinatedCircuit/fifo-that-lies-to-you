...
HD_PWD='C:/Users/RISHIK NAIR/Downloads/To-do/FIFO_Random_Depth/FIFO_Random_Depth.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log chaos_fifo.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source chaos_fifo.tcl -notrace
