...
HD_PWD='C:/Users/RISHIK NAIR/Downloads/To-do/FIFO_Random_Depth/FIFO_Random_Depth.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log chaos_fifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source chaos_fifo.tcl
